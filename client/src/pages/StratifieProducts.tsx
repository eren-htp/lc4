...
import { STRATIFIE_PRODUCTS } from "@shared/stratifieProducts";
import { BRAND_LOGOS } from "@shared/brandLogos";
import { Home, Phone, Mail, ArrowLeft } from "lucide-react";

export default function StratifieProducts() {
  return (
      ...
      <main className="flex-1">
        ...
        <section className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
              ...
              <span>/</span>
              <Link href="/revetements-sols/sols-stratifies" className="hover:text-[#0D1B3E] transition-colors">Sols stratifiés</Link>
              <span>/</span>
        ...
        <section className="bg-gradient-to-br from-[#0D1B3E] to-[#1a3a6b] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            <img src={BRAND_LOGOS.alsafloor} alt="Alsafloor" className="h-10 md:h-14 object-contain brightness-0 invert mx-auto mb-4" />
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Sols Stratifiés</h1>
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Découvrez notre gamme de sols stratifiés Alsafloor : Osmoze, Allure, Allure Chic et placage bois Alsawood.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {STRATIFIE_PRODUCTS.map((product, index) => (
                <ScrollReveal key={product.id} delay={index * 0.05}>
                  <Link href={`/revetements-sols/sols-stratifies/produit/${product.id}`}>
        ...
        <section className="bg-[#0D1B3E] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Nos experts vous accompagnent dans le choix du sol stratifié adapté à votre projet.
            </p>
