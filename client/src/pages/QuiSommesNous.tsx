...
import { Clock, Warehouse, Handshake, MessageSquare, PaintBucket, Layers3, BrickWall } from "lucide-react";
import Header from "@/components/Header";
import Footer from "@/components/Footer";
import ScrollReveal from "@/components/ScrollReveal";
import NumberCounter from "@/components/NumberCounter";
import ValuesSection from "@/components/ValuesSection"; // Import du nouveau composant
	    ...
	    <div className="min-h-screen flex flex-col">
	      ...
	      <main className="flex-1">
	        ...
	        <section className="relative h-[50vh] flex items-center justify-center text-white bg-gradient-animated-dark">
	          ...
	          <div className="relative z-10 text-center px-4 hero-animate">
	            <h1 className="text-5xl md:text-6xl font-bold">Qui sommes-nous ?</h1>
	          </div>
	        </section>

	        {/* Notre histoire - Section 1: La Genèse */}
	        <section className="py-20 bg-gray-50">
	          <div className="container mx-auto px-4">
	            <div className="max-w-6xl mx-auto">
	              <h2 className="text-4xl font-bold mb-16 text-[#0D1B3E] text-center">Notre Histoire, Notre Engagement</h2>
	              <ScrollReveal>
