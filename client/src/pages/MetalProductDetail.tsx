...
import { METAL_PRODUCTS } from "@shared/metalProducts";
import {
  Home,
  Phone,
  Mail,
...
export default function MetalProductDetail() {
  const [, params] = useRoute("/peintures/metal/produit/:productId");
  const product = METAL_PRODUCTS.find((p) => p.id === params?.productId);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/peintures/metal/produits">
        ...
        <section className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
              ...
              <span>/</span>
              <Link href="/peintures/metal" className="hover:text-[#0D1B3E] transition-colors">
                Métal
              </Link>
              <span>/</span>
              <Link href="/peintures/metal/produits" className="hover:text-[#0D1B3E] transition-colors">
                Produits
              </Link>
              <span>/</span>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {product.documentation.fiche_technique && (
                        <a
                          href={product.documentation.fiche_technique.startsWith("http") ? product.documentation.fiche_technique : "#"}
                          target="_blank"
                      ...
                      {product.documentation.plaquette && (
                        <a
                          href={product.documentation.plaquette}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm border border-gray-200 transition-colors"
                        >
        ...
        <section className="bg-[#0D1B3E] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Nos experts sont à votre disposition pour vous conseiller sur la peinture métal la plus adaptée à votre projet.
            </p>
