    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
              ...
              <span>/</span>
              <Link href="/revetements-sols/sols-pvc" className="hover:text-[#0D1B3E] transition-colors">Sols PVC</Link>
              <span>/</span>
        ...
        <div className="container mx-auto px-4 py-4">
          <Link href="/revetements-sols/sols-pvc">
        ...
        <section className="bg-gradient-to-br from-[#0D1B3E] to-[#1a3a6b] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-6 mb-4">
              <img src={BRAND_LOGOS.tarkett} alt="Tarkett" className="h-8 md:h-10 object-contain brightness-0 invert" />
              <img src={BRAND_LOGOS.alsafloor} alt="Alsafloor" className="h-8 md:h-10 object-contain brightness-0 invert" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Sols PVC</h1>
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Découvrez notre gamme complète de revêtements PVC : sols rigides clipsables, vinyles modulaires et solutions professionnelles.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {PVC_PRODUCTS.map((product, index) => (
                <ScrollReveal key={product.id} delay={index * 0.05}>
                  <Link href={`/revetements-sols/sols-pvc/produit/${product.id}`}>
        ...
        <section className="bg-[#0D1B3E] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Nos experts vous accompagnent dans le choix du revêtement PVC adapté à votre projet.
            </p>
