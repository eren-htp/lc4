...
export default function BoisProductDetail() {
  const [, params] = useRoute("/peintures/bois/produit/:productId");
  const product = BOIS_PRODUCTS.find((p) => p.id === params?.productId);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/peintures/bois/produits">
        ...
        <section className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
              ...
              <span>/</span>
              <Link href="/peintures/bois/produits" className="hover:text-[#0D1B3E] transition-colors">
                Produits
              </Link>
              <span>/</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="inline-block bg-[#0D1B3E] text-white px-3 py-1 rounded-full text-xs font-bold">
                    {product.marque}
                  </span>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  {product.finition && (
                    <span className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-semibold bg-amber-50 text-amber-700 border border-amber-200">
                      {product.finition}
                    </span>
                  )}
                </div>
                ...
                {product.systeme_application && (
                  <div className="mb-8">
                    ...
                    <p className="text-gray-700 text-lg">{product.systeme_application}</p>
                  </div>
                )}
        ...
        <section className="bg-[#0D1B3E] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Nos experts sont à votre disposition pour vous conseiller sur la peinture bois la plus adaptée à votre projet.
            </p>
