...
export default function ImpressionProductDetail() {
  const [, params] = useRoute("/peintures/impressions/produit/:productId");
  const product = IMPRESSIONS_PRODUCTS.find((p) => p.id === params?.productId);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/peintures/impressions/produits">
        ...
        <section className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
              ...
              <span>/</span>
              <Link
                href="/peintures/impressions/produits"
                className="hover:text-[#0D1B3E] transition-colors"
              >
                Produits
              </Link>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                {/* Système d'application si disponible */}
                {product.systeme_application && (
                  <div className="mb-8">
                    <div className="flex items-center gap-2 mb-4">
                      <Shield className="h-5 w-5 text-[#0D1B3E]" />
                      <h2 className="text-xl font-bold text-[#0D1B3E]">
        ...
        <section className="bg-[#0D1B3E] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Nos experts sont à votre disposition pour vous conseiller sur le
              produit le plus adapté à votre projet.
            </p>
