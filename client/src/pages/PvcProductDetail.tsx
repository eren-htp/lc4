...
export default function PvcProductDetail() {
  const { id } = useParams<{ id: string }>();
  const product = PVC_PRODUCTS.find((p) => p.id === id);
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/revetements-sols/sols-pvc/produits">
              <Button className="bg-[#0D1B3E] hover:bg-[#0D1B3E]/90">Retour aux produits PVC</Button>
            </Link>
          </div>
        </main>
        <Footer />
        ...
        <section className="bg-gray-50 border-b border-gray-200">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-600 flex-wrap">
              ...
              <span>/</span>
              <Link href="/revetements-sols/sols-pvc/produits" className="hover:text-[#0D1B3E] transition-colors">Produits</Link>
              <span>/</span>
          ...
          <div className="container mx-auto px-4">
            <Link href="/revetements-sols/sols-pvc/produits">
              <Button variant="outline" className="text-[#0D1B3E] border-[#0D1B3E] hover:bg-[#0D1B3E] hover:text-white">
                <ChevronLeft className="w-4 h-4 mr-2" />Retour aux produits PVC
              </Button>
            </Link>
          </div>
        </section>
