...
export default function LaquesTenduProducts() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="container mx-auto px-4 py-4">
          <Link href="/peintures/peintures-laques-tendu">
            <Button variant="ghost" className="text-[#0D1B3E] hover:bg-gray-100 gap-2">
              <ArrowLeft className="h-4 w-4" />
              Retour aux Peintures laques tendu
            </Button>
          </Link>
        </div>
        ...
        <section className="bg-gradient-to-br from-[#0D1B3E] to-[#1a3a6b] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-6 mb-4">
              <img src={BRAND_LOGOS.blancolor} alt="Blancolor" className="h-8 md:h-10 object-contain brightness-0 invert" />
              <img src={BRAND_LOGOS.astral} alt="Astral Bâtiment" className="h-8 md:h-10 object-contain brightness-0 invert" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Peintures Laques Tendu</h1>
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Découvrez notre gamme de peintures laques : finitions mates, satinées et brillantes pour boiseries, menuiseries et murs intérieurs.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {LAQUES_TENDU_PRODUCTS.map((product, index) => (
                <ScrollReveal key={product.id} delay={index * 0.05}>
                  <Link href={`/peintures/peintures-laques-tendu/produit/${product.id}`}>
        ...
        <section className="bg-[#0D1B3E] text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/80">
              Nos experts vous accompagnent dans le choix de la peinture laque adaptée à votre projet.
            </p>
